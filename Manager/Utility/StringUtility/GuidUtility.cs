...
namespace Utility.StringUtility
{
    public static class GuidUtility
    {
        ...
        {
            var dt = DateTime.Now;
            return string.Format("{0:yyyyMMddHHmmssfffffff}", dt);
        }
        #endregion

        #region New32GUID
        public static string New32GUID()
        {
        ...
        #region NewDTGUID
        public static string NewDTGUID()
        {
            var dt = DateTime.Now;
            return string.Format("{0:yyyyMMddHHmmssfffffff}{1:N}", dt, Guid.NewGuid());
        }
        #endregion
